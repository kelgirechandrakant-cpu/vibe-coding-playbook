...
- [Test](#test)
- [Verify](#verify)
- [Commit & Maintain](#commit--maintain)
...
### When NOT to Let AI Make the Decision
...
### Git Discipline
Commit early and often — not one giant commit per feature. Use a branch per feature so a bad AI-generated change can be discarded without touching main. Write commit messages that describe what changed and why, not `fix stuff`. If your AI agent proposes a change spanning 10+ files for one task, that's a sign the task wasn't broken down small enough — see Breaking Work Into Small Tasks.
